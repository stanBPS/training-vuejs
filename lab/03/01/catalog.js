            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select id="item" class="form-control" v-model="itemSelected">
                        <option v-for="item in itemsSorted" :key="item.title" :value="item">{{item.title}}
                            ({{item.author}})</option>
                    </select>
                </div>
                <div class="form-group">
                    <button type="button" class="btn btn-secondary btn-block" :disabled="itemSelected === undefined" @click="emitAddToCart">Ajouter au panier</button>
                </div>
            </div>
        </div>
    `,
